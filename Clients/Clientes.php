...
<div class="ima" id="date"><img src="/imagenes/Logo_original_green.png" width="100%" height="150" /></div>
...
<div class="enlazando" id="msj"><h1><marquee>Enlazando ingen&iacute;o y tecnolog&iacute;a</marquee></h1></div>
	<div class="menu" id="opcion"> </div>
		...
		<div class="contenedor" id="base">	
			<iframe src="/Opciones_Clientes.html" name="medio" align="left" frameborder="0" scrolling="no" width="100%" height="100%"</iframe></iframe>
		</div>
